...
# Look into flextable, reactable, or gt as other option for formatting and colour-coding. Use datatable for anything that needs to be searchable, formattable for lovely design.
...
# I'm sure there's a better way to assign colours! Maybe simplify with lapply?
